  ...
  return (
    <motion.div
      ...
      style={{
        ...
        // Bind CSS Custom property for Framer Motion setProperty compatibility
        ["--offset-distance" as any]: itemOffset,
        offsetDistance: "var(--offset-distance)",
        WebkitOffsetDistance: "var(--offset-distance)",
...
const MarqueeAlongSvgPath = ({
  ...
  // Responsive scaling using direct DOM manipulation & ResizeObserver
  useEffect(() => {
    ...
    const updateScale = () => {
      ...
      const scaleY = wrapperHeight > 0 ? wrapperHeight / originalHeight : scaleX
      ...
      const offsetY = wrapperHeight > 0 ? (wrapperHeight - scaledHeight) / 2 : 0
